...
//review w/ tutor
// var rank = localStorage.getItem("AG" );
// console.log(rank);

// var tableSection = document.getElementById("hsTable");
// console.log(tableSection)
// tableSection.textContent="hello world";

// var scoresEl = document.createElement("button");
// scoresEl.textContent="click me";
// console.log(scoresEl)

// tableSection.appendChild(scoresEl)
// highscores.js
// scores.js
